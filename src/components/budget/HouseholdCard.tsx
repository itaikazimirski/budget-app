...
export default function HouseholdCard({ category, accountId, year, month, transactions }: HouseholdCardProps) {
        ...
        {editing && (
          ...
          >
            ...
            <div className="flex gap-2">
              ...
              <button onClick={() => setEditing(false)} className="px-3 py-1.5 text-slate-400 hover:text-slate-600 text-sm">
                ביטול
              </button>
            </div>
          </div>
