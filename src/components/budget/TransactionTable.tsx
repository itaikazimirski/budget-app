        ...
        <div className="flex gap-2 mb-3">
          <button
            ...
            className={`flex-1 py-1.5 text-sm rounded-lg font-medium transition-colors ${
              type === 'expense' ? 'bg-rose-100 text-rose-700' : 'bg-white text-slate-500 border border-slate-200 hover:bg-slate-100'
            }`}
          >
            הוצאה
          </button>
          <button
            ...
            className={`flex-1 py-1.5 text-sm rounded-lg font-medium transition-colors ${
              type === 'income' ? 'bg-emerald-100 text-emerald-700' : 'bg-white text-slate-500 border border-slate-200 hover:bg-slate-100'
            }`}
          >
            הכנסה
          </button>
